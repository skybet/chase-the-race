<html>
  ...
  <body>
    ...
    ?>
    <div class="container">
      <h1 class="pageTitle">Chase the Race - Admin Page</h1>
      <form class="predictionForm" action="drawResultsPage.php" method="post">

        <h2>Select the correct results</h2>
          ...
          Select the team with the fastest Pit Stop time:
          ...
          Was the safety car used:
          <input type="checkbox" name="safetyCar">
          <br>

          Tiebreaker - How many total pit stops were made:
